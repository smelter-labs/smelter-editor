...
function PictureOnPictureLayout() {
    ...
    return ((0, jsx_runtime_1.jsx)(smelter_1.View, { style: { width, height, direction: 'column', overflow: 'visible' }, children: inputs.map((input) => ((0, jsx_runtime_1.jsx)(smelter_1.Rescaler, { style: {
                width,
                height,
                top: 0,
                left: 0,
