...
export function PictureInPictureLayout() {
  ...
  const pipWidth = isVertical
    ? Math.round(width * 0.8)
    : Math.round(width * 0.25);
  const pipHeight = isVertical
  ...
  const tileAbsTop =
    pipTop + tilePadding + swap.incomingPrevIndex * (tileH + tilePadding * 2);
          ...
          <Rescaler
            style={{
              ...
              width: swapOutgoingEnabled
                ? width - swap.progress * (width - tileW)
                : width,
              height: swapOutgoingEnabled
                ? height - swap.progress * (height - tileH)
                : height,
            }}>
          ...
          <Rescaler
            ...
            <Shader
              ...
              shaderParam={{
                type: 'struct',
                value: [
                  { type: 'f32', fieldName: 'opacity', value: fadeOpacity },
                ],
              }}>
              <View
                style={{
                ...
                <Tiles
                  ...
                  style={{ padding: tilePadding, verticalAlign: 'top' }}>
