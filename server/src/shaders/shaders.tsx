...
const AVAILABLE_SHADERS: AvailableShader[] = [
  ...
  },
  {
    ...
    name: 'Corner Pin',
    description:
      'Perspective corner-pin: displace each of the four video corners by an (x, y) offset and the content perspective is warped to match the dragged corners.',
    shaderFile: 'corner-pin.wgsl',
    params: [
      {
        name: 'tl_x',
        type: 'number',
  ...
  },
  {
    ...
    name: 'VHS Distortion',
    description:
      'Analog VHS-style distortion with tape jitter, chroma bleed, scanlines, dropouts, noise, ghosting, and warm tape tint.',
    shaderFile: 'vhs-distortion.wgsl',
    params: [
      {
        name: 'jitter_x_px',
        type: 'number',
  ...
  },
  {
    ...
    name: 'Pong',
    description:
      'Auto-playing Pong: ball bounces deterministically off walls, paddles AI-track with imperfect timing. Input texture renders inside the ball and (optionally) inside the paddles.',
    shaderFile: 'pong.wgsl',
    params: [
      {
        name: 'ball_radius',
        type: 'number',
      ...
      {
        name: 'manual_countdown_remaining',
        type: 'number',
        minValue: 0,
        maxValue: 10,
        defaultValue: 0,
