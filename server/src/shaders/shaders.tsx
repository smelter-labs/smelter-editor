...
const AVAILABLE_SHADERS: AvailableShader[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'opacity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.64 },
      { name: 'scanline_intensity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.65 },
      { name: 'scanline_density', type: 'number', minValue: 10, maxValue: 500, defaultValue: 73.7 },
      { name: 'scanline_speed', type: 'number', minValue: 0, maxValue: 50, defaultValue: 10.5 },
      ...
      { name: 'noise_intensity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.1 },
      { name: 'jitter_x_px', type: 'number', minValue: 0, maxValue: 20, defaultValue: 6.8 },
