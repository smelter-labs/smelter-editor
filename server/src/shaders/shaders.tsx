...
const AVAILABLE_SHADERS: AvailableShader[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'tint_r', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.15 },
      { name: 'tint_g', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.44 },
      { name: 'tint_b', type: 'number', minValue: 0, maxValue: 1, defaultValue: 1.0 },
      { name: 'opacity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.79 },
      ...
      { name: 'scanline_speed', type: 'number', minValue: 0, maxValue: 50, defaultValue: 8.5 },
      ...
      { name: 'jitter_x_px', type: 'number', minValue: 0, maxValue: 20, defaultValue: 3.4 },
      ...
      { name: 'glow_intensity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.19 },
      { name: 'edge_glow_width', type: 'number', minValue: 0, maxValue: 0.5, defaultValue: 0.09 },
      { name: 'brightness', type: 'number', minValue: 0.5, maxValue: 5, defaultValue: 3.47 },
      { name: 'bloom_intensity', type: 'number', minValue: 0, maxValue: 2, defaultValue: 0.42 },
      { name: 'bloom_radius', type: 'number', minValue: 1, maxValue: 50, defaultValue: 31.38 },
    ],
  },
  {
    id: 'perspective',
