...
const AVAILABLE_SHADERS: AvailableShader[] = [
  ...
  },
  {
    ...
    name: 'Equalizer',
    description:
      'Audio equalizer visualization with 16 frequency bands rendered as vertical bars.',
    shaderFile: 'equalizer.wgsl',
    params: [
      { name: 'band_0', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_1', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_2', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_3', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_4', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_5', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_6', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_7', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_8', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_9', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_10', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_11', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_12', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_13', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_14', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'band_15', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0 },
      { name: 'bar_color_r', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.2 },
      { name: 'bar_color_g', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.8 },
      { name: 'bar_color_b', type: 'number', minValue: 0, maxValue: 1, defaultValue: 1.0 },
      { name: 'bg_opacity', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.8 },
      { name: 'glow', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.5 },
      { name: 'gap', type: 'number', minValue: 0, maxValue: 0.9, defaultValue: 0.2 },
      { name: 'bar_count', type: 'number', minValue: 1, maxValue: 64, defaultValue: 16 },
      { name: 'smoothing', type: 'number', minValue: 0, maxValue: 1, defaultValue: 0.3 },
    ],
  },
];
