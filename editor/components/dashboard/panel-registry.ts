...
export const LAYOUT_PRESETS: LayoutPreset[] = [
  {
    ...
    layout: [
      ...
      { i: 'buttons', x: 16, y: 8, w: 8, h: 6, minW: 4, minH: 4 },
  ...
  },
  {
    ...
    layout: [
      ...
      { i: 'buttons', x: 6, y: 14, w: 6, h: 10, minW: 4, minH: 4 },
  ...
  },
  {
    ...
    layout: [
      ...
      { i: 'buttons', x: 12, y: 10, w: 12, h: 6, minW: 4, minH: 4 },
...
export const SMALL_LAYOUT: MutableLayout = [
  ...
  { i: 'add-video', x: 0, y: 10, w: 12, h: 6, minW: 4, minH: 4 },
  { i: 'buttons', x: 0, y: 16, w: 12, h: 4, minW: 4, minH: 4 },
