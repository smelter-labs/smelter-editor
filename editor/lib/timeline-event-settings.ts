...
function setTimelineEventsEnabledSetting(value: boolean): void {
  if (typeof window === 'undefined') {
    return;
  }
...
function getTimelineEventsPositionSetting(): FeedbackPosition {
  if (typeof window === 'undefined') {
...
function getTimelineEventsSizeSetting(): FeedbackSize {
  if (typeof window === 'undefined') {
    return DEFAULT_SIZE;
  }
...
function setTimelineEventsSizeSetting(value: FeedbackSize): void {
  if (typeof window === 'undefined') {
    return;
  }
...
function getTimelineEventsDurationSetting(): number {
  if (typeof window === 'undefined') {
...
function setTimelineEventsDurationSetting(value: number): void {
  if (typeof window === 'undefined') {
    return;
  }
